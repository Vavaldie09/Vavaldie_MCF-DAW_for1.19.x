...
#tum
execute if data storage va_music: {Data:{Drum:"A1"}} if score O va_Time matches 4 as @a at @s run playsound minecraft:block.note_block.basedrum record @s ~ ~ ~ 1 2 0
execute if data storage va_music: {Data:{Drum:"A1"}} if score O va_Time matches 7 as @a at @s run playsound minecraft:block.note_block.basedrum record @s ~ ~ ~ 1 2 0
execute if data storage va_music: {Data:{Drum:"A1"}} if score O va_Time matches 12 as @a at @s run playsound minecraft:block.note_block.basedrum record @s ~ ~ ~ 1 2 0
execute if data storage va_music: {Data:{Drum:"A1"}} if score O va_Time matches 15 as @a at @s run playsound minecraft:block.note_block.basedrum record @s ~ ~ ~ 1 2 0

#snear
execute if data storage va_music: {Data:{Drum:"A1"}} if score O va_Time matches 9 as @a at @s run playsound minecraft:block.note_block.snare record @s ~ ~ ~ 1 0 0
