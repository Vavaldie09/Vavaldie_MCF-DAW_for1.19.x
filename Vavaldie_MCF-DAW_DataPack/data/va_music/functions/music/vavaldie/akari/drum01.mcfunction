...
execute if score M va_Time matches 4 run data modify storage va_music: Data.Drum set value "A2"
execute if score M va_Time matches 5 run data modify storage va_music: Data.Drum set value "A1"
execute if score M va_Time matches 6 run data modify storage va_music: Data.Drum set value "A2"
execute if score M va_Time matches 7 run data modify storage va_music: Data.Drum set value "A1"
execute if score M va_Time matches 8 run data modify storage va_music: Data.Drum set value "A2"
...
execute if data storage va_music: {Data:{Drum:"A1"}} if score O va_Time matches 3 as @a at @s run playsound minecraft:block.note_block.snare record @s ~ ~ ~ 1 1 0
execute if data storage va_music: {Data:{Drum:"A1"}} if score O va_Time matches 7 as @a at @s run playsound minecraft:block.note_block.snare record @s ~ ~ ~ 1 1 0
execute if data storage va_music: {Data:{Drum:"A1"}} if score O va_Time matches 11 as @a at @s run playsound minecraft:block.note_block.snare record @s ~ ~ ~ 1 1 0
execute if data storage va_music: {Data:{Drum:"A1"}} if score O va_Time matches 15 as @a at @s run playsound minecraft:block.note_block.snare record @s ~ ~ ~ 1 1 0
...
execute if data storage va_music: {Data:{Drum:"A2"}} if score O va_Time matches 3 as @a at @s run playsound minecraft:block.note_block.snare record @s ~ ~ ~ 1 1 0
execute if data storage va_music: {Data:{Drum:"A2"}} if score O va_Time matches 7 as @a at @s run playsound minecraft:block.note_block.snare record @s ~ ~ ~ 1 1 0
execute if data storage va_music: {Data:{Drum:"A2"}} if score O va_Time matches 11 as @a at @s run playsound minecraft:block.note_block.snare record @s ~ ~ ~ 1 1 0
execute if data storage va_music: {Data:{Drum:"A2"}} if score O va_Time matches 15 as @a at @s run playsound minecraft:block.note_block.snare record @s ~ ~ ~ 1 1 0
